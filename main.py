...
Original file is located at
    https://colab.research.google.com/drive/1OWTJe6SohnON5tE0GcO5wSYfgbp9rmK3
...
print("Hello,", name +" "+ surname + "!" + "I know your age, you are " + age + " years old!")
...
if b % a == 0:
    result = "a can be divided by b"
else:
    result = "a can't be divided by b"
...
if side2 > max:
  max = side2
  if side1 + side3 > max:
    result  = "a triangle can be drawn with the given sides"
...
if side3 + side2 > side1:
    ...
    result = "a triangle can't be drawn with the given sides"
